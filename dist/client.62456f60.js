...
exports.default = _default;
  ...
  return _c("button", { on: { click: _vm.emitClick } }, [_vm._v("OK")])
}
var staticRenderFns = []
...
},{"./eventBus":"eventBus.js","_css_loader":"node_modules/parcel-bundler/src/builtins/css-loader.js","vue-hot-reload-api":"node_modules/vue-hot-reload-api/dist/index.js","vue":"node_modules/vue/dist/vue.runtime.esm.js"}],"App.vue":[function(require,module,exports) {
"use strict";
...
var _default = {
  ...
  methods: {
    onIncreaseNumber: function onIncreaseNumber() {
      _eventBus.default.$emit('increaseNumber');
    },
  ...
  mounted: function mounted() {
    ...
    _eventBus.default.$on('pushNumber', function (value) {
...
exports.default = _default;
  ...
  return _c(
    "div",
    [
      _c("p", [_vm._v(_vm._s(_vm.number))]),
      _vm._v(" "),
      _c("btn", { on: { increaseNumber: _vm.onIncreaseNumber } })
    ],
    1
  )
}
...
},{"./eventBus":"eventBus.js","./btn":"btn.vue","vue-hot-reload-api":"node_modules/vue-hot-reload-api/dist/index.js","vue":"node_modules/vue/dist/vue.runtime.esm.js"}],"client.js":[function(require,module,exports) {
"use strict";
...
var client = socketIOClient('http://localhost:8080');
new _vue.default({
  el: "#app",
  created: function created() {
    _eventBus.default.$on('increaseNumber', function (value) {
      client.emit('onNumberChange', value);
    });

    _eventBus.default.$on();
  },
  render: function render(h) {
...
client.on('pushNumber', function (value) {
  _eventBus.default.$emit('pushNumber', value);
});
},{"socket.io-client":"node_modules/socket.io-client/lib/index.js","vue":"node_modules/vue/dist/vue.runtime.esm.js","./App.vue":"App.vue","./eventBus":"eventBus.js"}],"node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
